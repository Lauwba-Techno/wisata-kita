...
class GaleriAdapter(
    ...
    inner class ViewHolder(val itemGaleriAdapterBinding: ItemGaleriAdapterBinding) :
        RecyclerView.ViewHolder(itemGaleriAdapterBinding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemGaleriAdapterBinding.inflate(LayoutInflater.from(parent.context), parent, false)
